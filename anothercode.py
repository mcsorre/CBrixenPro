...
if st.session_state.page == 0:
  ...
  if st.session_state.user_input:
    if st.session_state.user_input.lower() == str(st.session_state.rand_item):
      ...
      img = Image.open(picture)
      st.image(img, width=300)
      placeholder.header("Great job! That is correct!. :star-struck: :tada: :confetti_ball:")
      ...
      img = Image.open(picture)
      st.image(img, width=300)
      placeholder.header("Unfortunately, that is not correct. :slightly_frowning_face:")
