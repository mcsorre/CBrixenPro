...
if st.session_state.page == 0:
  ...
  with placeholder.container():
    ...
    st.write("\n")
    st.caption(':blue[Embark on a linguistic adventure with the _immersive IPA (International Phonetic Alphabet) Quiz_] :red[designed to challenge and enhance your understanding of _English pronunciation_]')
    st.write("\n")
